...
public class ListAdapterSubCategoria extends RecyclerView.Adapter<ListAdapterSubCategoria.ViewHolder> {
    ...
    public ListAdapterSubCategoria(List<Producto> itemList, LayoutInflater layoutInflater, Context context) {
        this.datos = itemList;
    ...
    @NonNull
    @Override
    public ListAdapterSubCategoria.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.cardview_px,null);
        return new ListAdapterSubCategoria.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListAdapterSubCategoria.ViewHolder holder, int position) {
